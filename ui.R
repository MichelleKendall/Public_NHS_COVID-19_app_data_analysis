      ...
      sidebarLayout(
        ...
        mainPanel(
          ...
          h3("- The government dashboard data for England includes PCR and LFD positive tests, whereas for Wales only PCR tests are counted. 
             ...
             If an app user inputs multiple positive tests on the same day, these are counted once. 
             ...
             These factors may be distorting the metric, particularly since the introduction of policies allowing 'early' release from self-isolation with
             negative lateral flow results, which are likely to have increased the numbers of people taking lateral flow test in the days following a positive LFD or PCR."),
          h3("- The government dashboard data includes reinfections (after six weeks) for Wales but not yest for England. 
             Positive tests reported through the app may include reinfections. 
             This will artificially inflate the apparent proportion of cases being reported through the app, particularly since the arrival of 
             the Omicron variant where reinfections have become more common."),
